...
func defaultHandler(writer http.ResponseWriter, request *http.Request) {
	...
	fmt.Fprint(writer, "<!doctype html><html><head><title>Welcome to Kubelogin</title></head><body><h1>Kubelogin</h1><p>For kubelogin to work appropriately, there are a few things you'll need to setup on your own machine/environment! <br>These specs can be found on the github page <a href=https://github.com/Nordstrom/kubelogin/tree/master>here!</a> <br></p><h2>Kubelogin CLI</h2><p>Kubelogin CLI supports the following operating systems <ul><li><a href=https://github.com/Nordstrom/kubelogin/releases/download/v0.0.51/kubelogin-cli-v0.0.51-darwin.tar.gz>Click me for MacOS!</a></li><li><a href=https://github.com/Nordstrom/kubelogin/releases/download/v0.0.51/kubelogin-cli-v0.0.51-windows.zip>Click me for Windows!</a></li><li><a href=https://github.com/Nordstrom/kubelogin/releases/download/v0.0.51/kubelogin-cli-v0.0.51-linux.tar.gz>Click me for Linux!</a></li></ul></p></body></html>")
}
